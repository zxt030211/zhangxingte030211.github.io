...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 600,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='Gõ nhiều chữ a vào đây để xem kết quả nè'>",
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.facebook.com/zxt030211";
          },
        });
      }
    });
